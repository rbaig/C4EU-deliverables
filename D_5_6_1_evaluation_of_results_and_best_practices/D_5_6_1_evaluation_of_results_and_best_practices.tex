...
\author{
    ...
    Jaume~Barcelo % \IEEEmembership{Life~Fellow,~IEEE}% <-this % stops a space
...
% The paper headers
\markboth{C4EU 5.6.1: Evaluation of Results and Best Practices -a}%
{C4EU 5.6.1: Evaluation of Results and Best Practices -a}
...
\begin{abstract}
%\boldmath
This report specifies the driving principles of bottom up broadband initiatives.
These principles are developed to describe the best practices in terms of networking and communications, taking into account related reference models such as the open source community.
The report also includes a review of the project indicators and which is the current state of the project.
\end{abstract}
...
\begin{IEEEkeywords}
 Bottom-up-Broadband (BuB), principles, results
...
\IEEEPARstart{T}{his} report summarizes the principles that drive our work, the identified best practices and the results obtained so far.
...
Even though approaches such as fast prototyping are encouraged in BuB, BuB might not always be the fastest or more economical way to provide broadband access to Internet.
...
A further comparison between open source and bottom-up-broadband initiatives will be done in coming deliverables.
...
The Open Access Network model used in different Swedish networks is another example close to BuB. \cite{forzati2010oan} provides more details on that experiences where the separation between networks and service provisioning is the most relevant characteristic. 
...
\hline
Indicator & Low & Medium & High & Current (up to month 12)\\
