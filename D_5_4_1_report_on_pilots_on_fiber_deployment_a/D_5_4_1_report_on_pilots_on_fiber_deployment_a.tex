...
\title{Fiber from the Farm\\ (C4EU 5.4.1: Report on Pilots on Fiber Deployment)}
%
%
...
\author{
TODO Name~Name, %\IEEEmembership{Member,~IEEE,}
TODO and~Name~Name% \IEEEmembership{Life~Fellow,~IEEE}% <-this % stops a space
%Roger Baig Vi\~nas,
%Albert Boix Molas,
