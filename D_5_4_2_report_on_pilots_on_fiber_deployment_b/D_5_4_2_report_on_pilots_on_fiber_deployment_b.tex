...
\fancyhead[R]{ % right
C4EU 5.4.2: Report on Pilots on Fiber Deployment -b
}
\pagestyle{fancy}
...
\title{Fiber From The Farm (FFTF)\\ \emph{(C4EU 5.4.2: Report on Pilots on Fiber Deployment -b)}}
%
%
...
%\markboth{C4EU 5.4.2: Report on Pilots on Fiber Deployment -b}%
%{C4EU 5.4.2: Report on Pilots on Fiber Deployment -b}
