...
\section{Internal Workshop}
In order to check the progress of every pilot, there have been two workshops. In the first one, all the pilots which are carried out by degree or PhD students of the UPF where introduced to some of the partners belonging to the BuB branch of the C4EU project. These are the papers that where presented in the first workshop:
\begin{itemize}
...
The second workshop, consisted of a set of presentations and demos that tried to show to the partners the current progress of each pilot. The following are the papers that were presented: 
