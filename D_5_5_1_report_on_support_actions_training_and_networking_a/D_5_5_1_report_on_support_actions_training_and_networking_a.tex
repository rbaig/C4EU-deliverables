...
Four students have joined the project so far and they are provided training and guidance to complete the BuB pilots the are working on.
Each of the students has both one academic advisor and one mentor with extensive BuB experience.
These two roles complement each other in the education of the student.
The collaboration tools include are those commonly present in collaborative initiatives: workshops, mailing list, git repository and talks at international forums.
\end{abstract}
...
Section \ref{sec:mentor} describes the roles of mentor and adacemic advisor that will help the students participating in the pilots.
...
Additionally, we are preparing a web as mentioned in Section \ref{sec:web}.
The BuB4EU branch and the obtained results have also been presented in external international forums that are introduced in Section \ref{sec:forums}.
...
\caption{Pilots, students and mentors}
\label{tab:mentors}
\centering
\begin{tabular}{|c|c|c|}
\hline
Pilot & Student & Mentor \\
\hline
Open Sensor Network & Alejandro Andreu & Alex Posada and Tomas Diez\\
Free Europe WiFi & Ignacio Justel & Givanni Calcerano\\
FFTx & Jorge Beltran & Roger Baig\\
Mobile Node & Fernando Gros & Efrain Foglia\\
\hline
\end{tabular}
\end{table}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width = 11cm]{figures/luis.eps}
  \caption{Demo ``Spectrum Sensing with USRP-E110'' (UPF) and demo ``Network Coding as a WiMAX Link Reliability Mechanism: an Experimental Demonstration'' (MIT)}
...
As students are actively participating in this project, it is of paramount importance to provide them with help and guidance to make sure that they can accomplish their goals.
