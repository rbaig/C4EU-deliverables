...
Four students have joined the project so far and they are provided training and guidance to complete the BuB pilots they are working on.
...
The collaboration tools are those commonly present in collaborative initiatives: workshops, mailing list, git repository and talks at international forums.
\end{abstract}
...
\begin{figure}[htbp]
  ...
  \caption{Demo ``Spectrum Sensing with USRP-E110'' (UPF) and demo ``Network Coding as a WiMAX Link Reliability Mechanism: an Experimental Demonstration'' (MIT). Picture by Cristina Cano.}
