This report has been produced using open source tools such as {\LaTeX}\footnote{\url{http://www.latex-project.org/}} and \emph{git}\footnote{\url{http://git-scm.com/}}.
